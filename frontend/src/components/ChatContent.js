...
const ChatContent = () => {
  ...
  async function handleMesssage(e) {
    e.preventDefault();
    try {
      const Message = await apiService.sendMessage(message, currentUserData.id);
      console.log(Message);
    } catch (e) {
    } finally {
      setMessage("");
  ...
  return (
    <div className="  w-[67vw]  rounded-2xl h-[89vh] mx-4">
      ...
      <div className="h-[78vh] mt-3 ">
        <div className="h-[70vh] mx-4 overflow-auto p-4 ">
          ...
          <form onSubmit={handleMesssage}>
            <div class="relative flex w-[30vw] scale-90 mt-2 ">
              ...
              <input
                ...
                class="w-full focus:outline-none focus:placeholder-gray-400 text-gray-600 placeholder-gray-600 pl-12 bg-white shadow-lg rounded-xl py-3"
